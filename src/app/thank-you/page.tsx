          ...
          <div className="lg:col-start-2 ">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                ...
                your order has been placed successfully and is on its
                way.We&apos;ll email the details and receipt to{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                ...
                hang tight and We&apos;ll email you for confirmation when your
                order is Placed
              </p>
            )}
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                ...
                <div className="flex justify-between">
                  <p>Transaction Fee</p>
                  <p className="text-gray-900">{formatPrice(150)}</p>
                </div>
                <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                  <p className="text-base">Total</p>
                  <p className="text-base">{formatPrice(orderTotal + 150)}</p>
                </div>
              </div>
              <PaymentStatus
