...
var EmailTemplate = function (_a) {
    ...
    return (react_1.default.createElement(components_1.Html, null,
        ...
        react_1.default.createElement(components_1.Preview, null, "The marketplace for high-quality goods."),
        react_1.default.createElement(components_1.Body, { style: main },
            react_1.default.createElement(components_1.Container, { style: container },
                react_1.default.createElement(components_1.Img, { src: "/tajar-newsletter-sign-up2.jpeg", width: "150", height: "150", alt: "DigitalHippo", style: logo }),
                ...
                react_1.default.createElement(components_1.Text, { style: paragraph },
                    "Welcome to Tajar, the marketplace for high quality digital goods. Use the button below to ",
                    actionLabel,
                    "."),
